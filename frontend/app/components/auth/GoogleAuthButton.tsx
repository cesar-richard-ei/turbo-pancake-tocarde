...
export function GoogleAuthButton({ type, callbackPath, className = '' }: GoogleAuthButtonProps) {
  ...
  return (
    <button
      onClick={handleClick}
      className={`flex items-center justify-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 ${className}`}
      type="button"
    >
